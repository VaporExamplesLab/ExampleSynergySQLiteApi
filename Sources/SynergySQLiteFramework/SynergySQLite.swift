/////////////////////////////////////////////////////////////////////////////////
//  SynergySQLiteFramework/SynergySQLiteFramework.swift
//
//  Created by marc on 2016.03.29.
...
public struct SynergySQLite {
    ...
    public static func escapeLikeString(_ s: String, escapeChar: String) -> String {
        //var strOut = s.regexReplacing(pattern: "_", template: escapeChar + "_")
        //strOut = strOut.regexReplacing(pattern: "%", template: escapeChar + "%")
